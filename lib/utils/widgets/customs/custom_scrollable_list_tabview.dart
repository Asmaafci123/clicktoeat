library custom_scrollable_list_tabview;
...
@visibleForTesting
const EdgeInsetsGeometry kTabMargin = EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0);
...
class _ScrollableListTabViewState extends State<ScrollableListTabView> {
            ...
            itemBuilder: (context, index) {
              ...
              return ValueListenableBuilder<int>(
                ...
                builder: (_, i, __) {
                  ...
                  final borderColor = selected ? tab.activeBackgroundColor : dividerColor;
                  return Container(
                    height: 32,
                    margin: kTabMargin,
        ...
        Flexible(
          child: ScrollablePositionedList.builder(
            ...
            itemBuilder: (_, index) => Column(
              ...
              children: [
                Padding(
                  padding: kTabMargin.add(EdgeInsets.only(top: 22.h, left: 10.w)),
  ...
  Widget _buildInnerTab(int index) {
    final tab = widget.names[index];
    return Builder(
      builder: (_) {
        return DefaultTextStyle(
          style: TextStyle(color: const Color(0xFF03041D), fontSize: 22.sp, fontFamily: Constants.appFontBold),
          child: Text(tab),
        );
      },
    );
