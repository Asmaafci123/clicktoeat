...
import 'package:mealup/utils/widgets/hero_image_app_logo.dart';
...
class _ChangePassword1State extends State<ChangePassword1> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(ScreenUtil().setWidth(40), 0.0, ScreenUtil().setWidth(40), ScreenUtil().setHeight(40)),
                          child: Column(
                              ...
                              CustomElevatedButton(
                                ...
                                onPressed: () {
                                  if (_formKey.currentState!.validate()) {
                                    Constants.checkNetwork().whenComplete(() => callChangePasswordForgot());
                                  } else {
                                    setState(() {
                                      // validation error
                                      //_autoValidate = true;
  ...
  Future<BaseModel<CommonResponse>> callChangePasswordForgot() async {
