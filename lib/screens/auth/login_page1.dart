            ...
            return Column(
              ...
              children: [
                Padding(
                  ...
                  child: Hero(
                    tag: 'App_logo',
                    child: Center(child: Image.asset('assets/ic_intro_logo.png')),
                  ),
                ),
                SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            'Email',
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0, fontFamily: Constants.appFont),
                          ),
                        ),
                        Card(
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(hintText: 'Enter Your Email ID', hintStyle: TextStyle(color: Constants.colorHint), border: InputBorder.none),
                            ),
                          ),
                        ),
                        Row(
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                "Login",
                                style: TextStyle(fontFamily: Constants.appFont, fontWeight: FontWeight.w900, fontSize: 16.0),
                              ),
                            ),
                            onPressed: () {},
                          ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              'Create Now',
                              style: TextStyle(fontWeight: FontWeight.bold, fontFamily: Constants.appFont),
                            ),
                          ],
                        ),
                      ],
