...
class _SearchScreenState extends State<SearchScreen> {
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: TextStyle(fontSize: 16, fontFamily: Constants.appFont, color: Constants.colorTheme),
                                                ),
                                              ),
                                            ],
                                          ),
                                                  ...
                                                  RichText(
                                                    text: TextSpan(
                                                      children: [
                                                        ...
                                                        TextSpan(text: searchHistoryList[index], style: TextStyle(color: Constants.colorBlack, fontFamily: Constants.appFont, fontSize: 14)),
                                                      ],
                                                    ),
                                                  ),
                                                ],
  ...
  void onEditCompleted() {
    ...
    print('=====================================HISTORY+++++++++++++++++' + searchHistoryList.toString());
  }
}
