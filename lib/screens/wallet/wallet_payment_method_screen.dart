...
class _WalletPaymentMethodScreenState extends State<WalletPaymentMethodScreen> {
  ...
  Future<BaseModel<CommonResponse>> addUserBalance(String? paymentId) async {
                        ...
                        children: [
                              ...
                              child: listPayment.length > 0
                                  ? ListView.builder(
                                      ...
                                      itemBuilder: (BuildContext context, int index) => Column(
                                        children: [
                                          customRadioList(listPaymentName[index], listPayment[index], listPaymentImage[index]),
                                        ],
                                      ),
                                    )
                                  : Padding(
                          ...
                          Padding(
                            ...
                            child: CustomElevatedButton(
                              onPressed: () {
                                if (orderPaymentType != null) {
                                  if (orderPaymentType == 'RAZOR') {
                                    ...
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (BuildContext context) => WalletPaypalPayment(
                              ...
                              buttonLabel: Languages.of(context)!.topUpWallet,
                            ),
                          ),
                        ],
                      )),
