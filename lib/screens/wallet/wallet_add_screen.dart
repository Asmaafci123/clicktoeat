...
class _WalletAddScreenState extends State<WalletAddScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(title: '' //Languages.of(context).walletSetting,
            ),
        body: LayoutBuilder(
                            ...
                            children: [
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(color: Constants.colorBlack, fontFamily: Constants.appFontBold, fontSize: 22),
                                    ),
                                    Text(
                                      "${Languages.of(context)!.availableMealUpBalance} ${SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol)} $balance",
                                      style: TextStyle(color: Constants.colorBlack, fontFamily: Constants.appFont, fontSize: 16),
                                    ),
                                    SizedBox(
                                      height: 30,
                                    ),
                                      ...
                                      children: [
                                        ...
                                        TextField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintStyle: TextStyle(color: Constants.colorGray, fontSize: 25, fontFamily: Constants.appFontBold),
                                          ),
                                        ),
                                        SizedBox(
                                          height: 30,
                              ...
                              Container(
                                ...
                                child: RawMaterialButton(
                                  ...
                                  child: Text(
                                    'Process',
                                    style: TextStyle(color: Constants.colorWhite, fontFamily: Constants.appFontBold, fontSize: 20),
                                  ),
  ...
  Future<BaseModel<CommonResponse>> addUserBalance(map) async {
