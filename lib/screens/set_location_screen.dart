...
class _SetLocationScreenState extends State<SetLocationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ScreenUtil.init(BoxConstraints(maxWidth: screenWidth, maxHeight: screenHeight), designSize: Size(360, 690), orientation: Orientation.portrait);

    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBar(
          title: Languages.of(context)!.labelSetLocation,
        ),
        body: Container(
              ...
              return ConstrainedBox(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Padding(
                        padding: EdgeInsets.only(left: ScreenUtil().setWidth(30), top: ScreenUtil().setHeight(5), bottom: ScreenUtil().setHeight(5)),
                        child: Text(
                          Languages.of(context)!.labelSavedAddress,
                          style: TextStyle(fontSize: ScreenUtil().setSp(14), fontFamily: Constants.appFontBold),
                        ),
                      ),
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) => InkWell(
                                onTap: () {
                                  ...
                                  SharedPreferenceUtil.putString('selectedLat', _userAddressList[index].lat!);
                                  SharedPreferenceUtil.putString('selectedLng', _userAddressList[index].lang!);
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(top: 10, left: 30, bottom: 8),
                                      child: Text(
                                        _userAddressList[index].type != null ? _userAddressList[index].type! : '',
