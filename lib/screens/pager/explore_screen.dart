...
class ExploreScreen extends StatefulWidget {
  ...
  const ExploreScreen({Key? key, this.strSortBy, this.strQuickFilter, this.strSelectedCousinesId}) : super(key: key);
                ...
                child: Container(
                  ...
                  child: Scaffold(
                              ...
                              onTap: () {
                                ...
                                for (int i = 0; i < _allCuisineListData.length; i++) {
                                  if (_allCuisineListData[i].isChecked) {
                                    selectedCuisineListId.add(_allCuisineListData[i].id.toString());
                                  }
                                }
                                String commaSeparated = selectedCuisineListId.join(',');
                                print('Selected cuisine Id : ---' + commaSeparated);
                                Navigator.pop(context);
                                callGetFilteredDataList(commaSeparated, sortBy, quickFilter);
                              },
                              child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(color: Constants.colorWhite, fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(16)),
                                  ),
                                ),
                              ),
                            ),
                    ...
                    appBar: CustomAppBarWithButton(
                      title: Languages.of(context)!.labelFilter,
                      buttonText: Languages.of(context)!.labelClear,
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(18)),
                              ),
                              Padding(
                                  ...
                                  child: GridView.count(
                                    ...
                                    children: List.generate(_listQuickFilter.length, (index) {
                                      return GestureDetector(
                                        ...
                                        child: Row(
                                          children: [
                                            radioQuickFilter == index ? getChecked() : getunChecked(),
                                            Expanded(
                                              child: Padding(
                                                padding: EdgeInsets.only(left: ScreenUtil().setWidth(10)),
                                                child: Text(
                              ...
                              Text(
                                Languages.of(context)!.labelCuisines,
                                style: TextStyle(fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(18)),
                              ),
                              Flexible(
                                fit: FlexFit.loose,
                                child: Padding(
                                  ...
                                  child: Container(
                                    child: GridView.count(
                                      ...
                                      childAspectRatio: 5,
                                      mainAxisSpacing: 10,
                                      children: List.generate(_allCuisineListData.length, (index) {
                                        return InkWell(
                                          onTap: () {
                                            setState(() {
                                              _allCuisineListData[index].isChecked = !_allCuisineListData[index].isChecked;
                                            });
                                          },
                                          child: Row(
                                            children: [
                                              _allCuisineListData[index].isChecked ? getChecked() : getunChecked(),
                                              Padding(
                                                padding: EdgeInsets.only(left: ScreenUtil().setWidth(10)),
                                                child: Text(
    ...
    return SafeArea(
      child: Scaffold(
        appBar: CustomHomeAppBar(
          ...
          onSearchTap: () {
            Navigator.of(context).push(Transitions(transitionType: TransitionType.slideUp, curve: Curves.bounceInOut, reverseCurve: Curves.fastLinearToSlowEaseIn, widget: SearchScreen()));
          },
          onLocationTap: () {
            Navigator.of(context).push(Transitions(transitionType: TransitionType.none, curve: Curves.bounceInOut, reverseCurve: Curves.fastLinearToSlowEaseIn, widget: SetLocationScreen()));
          },
          selectedAddress: SharedPreferenceUtil.getString(Constants.selectedAddress).isEmpty ? '' : SharedPreferenceUtil.getString(Constants.selectedAddress),
        ),
        body: SmartRefresher(
          enablePullDown: true,
                                                        ...
                                                        children: [
                                                          Container(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              style: TextStyle(fontFamily: Constants.appFontBold, fontSize: ScreenUtil().setSp(16.0)),
                                                            ),
                                                          ),
                                                          GestureDetector(
                                                            onTap: () {
                                                              if (SharedPreferenceUtil.getBool(Constants.isLoggedIn)) {
                                                                Constants.checkNetwork().whenComplete(() => callAddRemoveFavorite(_exploreResListData[index].id));
                                                              } else {
                                                                Constants.toastMessage(Languages.of(context)!.labelPleaseLoginToAddFavorite);
                                                              }
                                                            },
                                                            child: Container(
                                                              margin: EdgeInsets.only(right: ScreenUtil().setWidth(5), top: ScreenUtil().setWidth(5)),
                                                              child: _exploreResListData[index].like!
                                                                  ? SvgPicture.asset(
                                                                      'assets/ic_filled_heart.svg',
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(
                                                          ...
                                                          style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorGray, fontSize: ScreenUtil().setSp(12.0)),
                                                        ),
                                                      ),
                                                    ),
                                                  ],
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              ...
                                                              Text(
                                                                _exploreResListData[index].distance.toString() + Languages.of(context)!.labelKmFarAway,
                                                                style: TextStyle(
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              margin: EdgeInsets.only(right: ScreenUtil().setWidth(5), bottom: ScreenUtil().setWidth(5)),
                                                              child: Padding(
                                                                padding: const EdgeInsets.only(right: 10),
                                                                child: (() {
                                                                  if (_exploreResListData[index].vendorType == 'veg') {
                                                                    return Row(
                                                                      children: [
                                                                        Padding(
                                                                  ...
                                                                  } else if (_exploreResListData[index].vendorType == 'non_veg') {
                                                                    return Row(
                                                                      children: [
                                                                        Padding(
                                                                          padding: const EdgeInsets.only(right: 2),
                                                                  ...
                                                                  } else if (_exploreResListData[index].vendorType == 'all') {
                                                                    return Row(
                                                                      children: [
                                                                        Padding(
                                                                          padding: const EdgeInsets.only(right: 2),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image(
                                    width: 150,
                                    height: 180,
                                    image: AssetImage('assets/ic_no_rest.png'),
                                  ),
                                  Padding(
                                    padding: EdgeInsets.only(top: ScreenUtil().setHeight(10)),
                                    child: Text(
