...
class _OrderReviewScreenState extends State<OrderReviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
          appBar: CustomAppBar(
            title: Languages.of(context)!.labelOrderReview,
          ),
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Image.asset('assets/ic_review_start.png'),
                              ],
                            ),
                          ),
                        ),
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsets.only(left: ScreenUtil().setWidth(5), bottom: ScreenUtil().setHeight(5), top: ScreenUtil().setHeight(15)),
                                    child: Text(
                                      ...
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                              hintText: Languages.of(context)!.labelAddYourValuableFeedback,
                                                ...
                                                children: [
                                                  Expanded(
                                                    child: TextFormField(
                                                      ...
                                                      decoration: InputDecoration(hintText: strCountryCode, hintStyle: TextStyle(color: Constants.colorHint), border: InputBorder.none),
                                                    ),
                                                  ),
                                                  Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: CustomElevatedButton(
                                      onPressed: () {
                                        if (_formKey.currentState!.validate()) {
                                          ...
                                          if (orderRate != 0) {
                                            ...
                                            Constants.toastMessage(Languages.of(context)!.labelPleaseGiveStar);
                                          }
                                        } else {
                                          setState(() {
                                            // validation error
                                      ...
                                      buttonLabel: Languages.of(context)!.labelSubmitIt,
                                    ),
                                  ),
                                ],
                              ),
  ...
  Future<BaseModel<CommonResponse>> callShareAppFeedback(double rate) async {
