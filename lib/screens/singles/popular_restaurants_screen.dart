...
class _PopularRestaurantsScreenState extends State<PopularRestaurantsScreen> {
                                          ...
                                          GestureDetector(
                                            onTap: () {
                                              if (SharedPreferenceUtil.getBool(Constants.isLoggedIn)) {
                                                Constants.checkNetwork().whenComplete(() => callAddRemoveFavorite(_topListData[index].id));
                                              } else {
                                        ...
                                        children: [
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 2.w),
                                              Text(
                                                _topListData[index].distance.toString() + Languages.of(context)!.labelKmFarAway,
                                                style: TextStyle(
                                                  fontSize: 12.sp,
                                                  fontFamily: Constants.appFont,
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              SizedBox(width: 2.w),
                                              Text(
                                                _topListData[index].avgDeliveryTime.toString() + ' mins',
                                                style: TextStyle(
                                                  fontSize: 12.sp,
                                                  fontFamily: Constants.appFont,
                                                  color: const Color(0xFF132229),
  ...
  String getPopularRestaurantsFood(int index) {
    ...
    if (_topListData.isNotEmpty) {
      var length = _topListData[index].cuisine!.length > 2 ? 2 : _topListData[index].cuisine!.length;
