...
class OrderDetailsScreen extends StatefulWidget {
  ...
  const OrderDetailsScreen({Key? key, this.orderId, this.orderDate, this.orderTime}) : super(key: key);
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  bool isAppliedCoupon = false, isPending = false, isTaxApplied = false, isVendorDiscount = false, isCanCancel = false;
  ...
  void initState() {
    ...
    // timer = Timer.periodic(Duration(seconds: SharedPreferenceUtil.getInt(Constants.appSettingDriverAutoRefresh)), (t) {
    setState(() {
      counter++;
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return Dialog(
              ...
              child: Padding(
                padding: EdgeInsets.only(left: ScreenUtil().setWidth(20), right: ScreenUtil().setWidth(20), bottom: 0, top: ScreenUtil().setHeight(20)),
                child: Container(
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(contentPadding: EdgeInsets.only(left: 10), hintText: Languages.of(context)!.labelTypeOrderCancelReason, border: InputBorder.none),
                            maxLines: 5,
                            style: TextStyle(
                          ...
                          children: [
                            GestureDetector(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(fontSize: ScreenUtil().setSp(14), fontWeight: FontWeight.bold, fontFamily: Constants.appFontBold, color: Constants.colorGray),
                              ),
                            ),
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (_textOrderCancelReason.text.isNotEmpty) {
                                    Navigator.pop(context);
                                    Constants.checkNetwork().whenComplete(() => callCancelOrder(widget.orderId, _textOrderCancelReason.text));
                                  } else {
                                    Constants.toastMessage(Languages.of(context)!.labelPleaseEnterCancelReason);
                                  }
                                },
                                child: Text(
                                  Languages.of(context)!.labelYesCancelIt,
                                  style: TextStyle(fontSize: ScreenUtil().setSp(14), fontWeight: FontWeight.bold, fontFamily: Constants.appFontBold, color: Constants.colorBlue),
                                ),
                              ),
                            ),
                          ],
                      ...
                      Card(
                        ...
                        child: Padding(
                          ...
                          child: TextField(
                            ...
                            keyboardType: TextInputType.text,
                            decoration: InputDecoration(contentPadding: EdgeInsets.only(left: 10), hintText: Languages.of(context)!.labelRaiseRefundRequestReason1, border: InputBorder.none),
                            maxLines: 5,
                            style: TextStyle(
                              fontFamily: Constants.appFont,
                              fontSize: 16,
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (_textRaiseRefundRequest.text.isNotEmpty) {
                                    Constants.checkNetwork().whenComplete(() => callRefundRequest(widget.orderId, _textRaiseRefundRequest.text));
                                  } else {
                                    Constants.toastMessage(Languages.of(context)!.labelPleaseEnterRaiseRefundReq);
                                  }
                                },
                                child: Text(
    ...
    return SafeArea(
      child: Scaffold(
        appBar: CustomAppBarWithButton(
          title: Languages.of(context)!.labelOrderDetails,
          buttonText: isCanCancel ? Languages.of(context)!.labelCancelOrder : '',
          buttonColor: Constants.colorLike,
          onPressed: () {
            showCancelOrderDialog();
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              (() {
                                  ...
                                  '',
                              style: TextStyle(color: Constants.colorGray, fontFamily: Constants.appFont, fontSize: 12),
                                                        ...
                                                        children: [
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              ...
                                                              overflow: TextOverflow.ellipsis,
                                                              maxLines: 2,
                                                              style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorGray, fontSize: 13),
                                                            ),
                                                          ),
                                                        ],
                                                      ),
                                    ...
                                    child: Padding(
                                      ...
                                      child: SvgPicture.asset(
                                        (() {
                                              if (strUserAddress != null) {
                                                if (strOrderStatus == 'PENDING') {
                                                  return 'assets/ic_pending.svg';
                                                } else if (strOrderStatus == 'APPROVE') {
                                                  return 'assets/ic_accept.svg';
                                                } else if (strOrderStatus == 'ACCEPT') {
                                                  return 'assets/ic_accept.svg';
                                                } else if (strOrderStatus == 'REJECT') {
                                                  return 'assets/ic_cancel.svg';
                                                } else if (strOrderStatus == 'PICKUP') {
                                                  return 'assets/ic_pickup.svg';
                                                } else if (strOrderStatus == 'DELIVERED') {
                                                  return 'assets/ic_completed.svg';
                                                } else if (strOrderStatus == 'CANCEL') {
                                                  return 'assets/ic_cancel.svg';
                                                } else if (strOrderStatus == 'COMPLETE') {
                                                  return 'assets/ic_completed.svg';
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  ...
                                                  style: TextStyle(fontSize: 15, fontFamily: Constants.appFontBold, fontWeight: FontWeight.w900),
                                                ),
                                                Text(
                                                  strDeliveryPerson!,
                                                  style: TextStyle(color: Constants.colorGray, fontFamily: Constants.appFont),
                                                ),
                                              ],
                                            ),
                                          ),
                                          Expanded(
                                            child: Padding(
                                              padding: EdgeInsets.only(right: ScreenUtil().setWidth(15), bottom: ScreenUtil().setHeight(15)),
                                              child: Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    ...
                                                    errorWidget: (context, url, error) => Container(
                                                      child: Center(child: Image.asset('assets/noimage.png')),
                                                    ),
                                                  ),
                                                ),
                                              ),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    ...
                                                    style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorTheme, fontSize: ScreenUtil().setSp(14)),
                                                  ),
                                                ],
                                              ),
                                              orderItemList[position].custimization != null && orderItemList[position].custimization!.length > 0
                                                  ? Container(
                                                      child: Text(
                                                        Languages.of(context)!.labelCustomizable,
                                                        style: TextStyle(color: Constants.colorTheme, fontFamily: Constants.appFont),
                                                      ),
                                                    )
                                                  : Container()
                                            ],
                                          ...
                                          Padding(
                                            ...
                                            child: Text(SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol) + orderItemList[position].price.toString(),
                                                style: TextStyle(fontFamily: Constants.appFont, fontSize: 14)),
                                          )
                                        ],
                                      ),
                                    );
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(right: 10),
                                      child: Text(
                                        SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol) + subTotal.toString(),
                                        style: TextStyle(fontFamily: Constants.appFont, fontSize: 14),
                                      ),
                                    )
                                  ],
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(right: 10),
                                      child: Text(
                                        '+ ' + SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol) + strDeliveryCharge!,
                                        style: TextStyle(fontFamily: Constants.appFont, fontSize: 14),
                                      ),
                                    )
                                  ],
                                              ...
                                              Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    '',
                                                    textAlign: TextAlign.start,
                                                    style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorTheme, fontWeight: FontWeight.w900, fontSize: 14),
                                                  ),
                                                ],
                                              ),
                                              Padding(
                                                padding: const EdgeInsets.only(right: 10),
                                                child: Text(
                                                  '- ' + SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol) + ' ' + couponPrice.toString(),
                                                  style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorLike, fontSize: 14),
                                                ),
                                              )
                                            ],
                                          ),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  "+ ${SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol)} " + taxAmount.toInt().toString(),
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                padding: EdgeInsets.only(right: ScreenUtil().setWidth(10)),
                                                child: Text(
                                                  "- ${SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol)} " + strVendorDiscount!,
                                                  style: TextStyle(fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(14)),
                                                ),
                                              )
                                            ],
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorTheme, fontSize: 16),
                                      ),
                                      Padding(
                                        padding: const EdgeInsets.only(right: 10),
                                        child: Text(
                                          SharedPreferenceUtil.getString(Constants.appSettingCurrencySymbol) + grandTotalAmount.toString(),
                                          style: TextStyle(fontFamily: Constants.appFont, color: Constants.colorTheme, fontSize: 14),
                                        ),
                                      )
                                    ],
                                  ),
                      ...
                      strOrderStatus == 'CANCEL' || strOrderStatus == 'COMPLETE'
                          ? Padding(
                              ...
                              child: CustomElevatedButton(
                                ...
                                buttonLabel: Languages.of(context)!.labelRaiseRefundRequest,
                              ),
                            )
                          : Container(),
                      SizedBox(
    ...
    try {
      ...
      setState(() {
        ...
        if (response.data!.deliveryPerson != null) {
          isPending = false;
          strDeliveryPerson = response.data!.deliveryPerson!.firstName! + ' ' + response.data!.deliveryPerson!.lastName!;
  ...
  Future<BaseModel<CommonResponse>> callRefundRequest(int? orderId, String refundRequestReason) async {
  ...
  Future<BaseModel<CommonResponse>> callCancelOrder(int? orderId, String cancelReason) async {
    CommonResponse response;
    try {
      Constants.onLoading(context);
      Map<String, String> body = {
