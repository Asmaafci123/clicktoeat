...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    businessAvailability = int.parse(json['business_availability'].toString());
    message = json['message'];
    isItemTax = int.parse(json['isItemTax'].toString());
    itemTax = json['item_tax'];
    taxType = json['tax_type'];
    vendorName = json['vendor_name'];
    driverName = json['driver_name'];
    recommendedMenu = json['recommanded_menu'];
    isPickup = int.parse(json['isPickup'].toString());
    isSameDayDelivery = json['isSameDayDelivery'];
    vendorDistance = json['vendor_distance'];
    paymentType = json['payment_type'];
    itemsCount = json['items_count'];
    customerNotification = int.parse(json['customer_notification'].toString());
    customerAppId = json['customer_app_id'];
    customerAuthKey = json['customer_auth_key'];
    customerApiKey = json['customer_api_key'];
    driverNotification = int.parse(json['driver_notification'].toString());
    driverAppId = json['driver_app_id'];
    driverAuthKey = json['driver_auth_key'];
    driverApiKey = json['driver_api_key'];
    vendorNotification = int.parse(json['vendor_notification'].toString());
    ...
    driverVehicleType = json['driver_vehical_type'];
    driverEarning = json['driver_earning'];
    twilioAccId = json['twilio_acc_id'];
    verification = int.parse(json['verification'].toString());
    verificationEmail = int.parse(json['verification_email'].toString());
    verificationPhone = int.parse(json['verification_phone'].toString());
    twilioAuthToken = json['twilio_auth_token'];
    twilioPhoneNo = json['twilio_phone_no'];
    radius = json['radius'];
    driverAutoRefresh = json['driver_auto_refrese'];
    ...
    customerMail = int.parse(json['customer_mail'].toString());
    vendorMail = int.parse(json['vendor_mail'].toString());
    driverMail = int.parse(json['driver_mail'].toString());
  ...
  Map<String, dynamic> toJson() {
    ...
    data['recommanded_menu'] = this.recommendedMenu;
    ...
    data['driver_accept_multiple_order_count'] = this.driverAcceptMultipleOrderCount;
    data['driver_assign_km'] = this.driverAssignKm;
    data['driver_vehical_type'] = this.driverVehicleType;
    ...
    data['driver_auto_refrese'] = this.driverAutoRefresh;
